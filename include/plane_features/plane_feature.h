...
//        Eigen::Matrix<double,3,1> p_IinC_;
    ...
    public:
        CornerFeature(){};
//        CornerFeature(int i, int j, int k,
//                      Eigen::Vector3d& position, Eigen::Matrix<double, 3, 3>& bases)
//        {
////            plane_ids_[0] = i;
////            plane_ids_[1] = j;
...
//        int dir_ids_[3];
//        Eigen::Vector3d position_; //
//        Eigen::Matrix<double, 3, 3> R_MtoG_;
    ...
    public:
        ...
        std::vector<Eigen::Vector3d> convex_hull_;  // convex hull on plane
        std::vector<cv::Point2f> measurements_;  // measurements on plane (for viz) AHC
        std::vector<cv::Point2f> meas_convex_; // measurements convex hull on 2D plane
