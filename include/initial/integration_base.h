...
#ifndef RVG_VIO_VIS_INTERGRATION_BASE_H
#define RVG_VIO_VIS_INTERGRATION_BASE_H
...
public:
    ...
    IntegrationBase(const Eigen::Vector3d &_acc_0, const Eigen::Vector3d &_gyr_0,
                    const Eigen::Vector3d &_linearized_ba, const Eigen::Vector3d &_linearized_bg,  const Eigen::Vector3d& inputG,
                    const double & acc_n, const double & gyr_n, const double & acc_w, const double & gyr_w)
            : acc_0{_acc_0}, gyr_0{_gyr_0}, linearized_acc{_acc_0}, linearized_gyr{_gyr_0},
              linearized_ba{_linearized_ba}, linearized_bg{_linearized_bg}, INPUT_G{inputG},
                                          ...
                                          const double Scale)
    {
        ...
        residuals.block<3, 1>(O_P, 0) = Qi.inverse() * (0.5 * INPUT_G * sum_dt * sum_dt + Scale * (Pj - Pi )- Vi * sum_dt) - corrected_delta_p;
        residuals.block<3, 1>(O_R, 0) = 2 * (corrected_delta_q.inverse() * (Qi.inverse() * Qj)).vec();
        residuals.block<3, 1>(O_V, 0) = Qi.inverse() * (INPUT_G * sum_dt + Vj - Vi) - corrected_delta_v;
...
#endif //RVG_VIO_VIS_INTERGRATION_BASE_H
