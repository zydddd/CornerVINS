...
// argv[3]: dataset path
// argv[4]: save path
// argv[5]: save traj name
// argv[5]: save time name
...
int main(int argc, char** argv)
{
    ...
    DatasetReader::LoadImageDataCID(datasetPath, imageData);
    DatasetReader::LoadImuDataCID(datasetPath, imuData);
    ...
    std::shared_ptr<RvgVio::VIOSystem> sys = std::make_shared<RvgVio::VIOSystem>(params);
    bool has_gt = false;
